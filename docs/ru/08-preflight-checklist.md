...
- [ ] Section roots используют `[section=...]` как переиспользуемый контракт секционного компонента, а не human заголовок.
...
- [ ] Auto Layout, constraints, clip content, исходный компонент и positioning заданы средствами Figma, а не ручными BRIDGE-тегами.
