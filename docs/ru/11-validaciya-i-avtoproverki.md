...
3. **Responsive validation** — coverage по breakpoint’ам, tree topology/cardinality, parent-child stability, content drift, order changes, полнота адаптивов.
...
- Responsive element tree cardinality или parent-child topology меняются без structural exception.
