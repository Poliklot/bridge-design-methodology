...
| --- | --- | --- |
| **B** | **Breakpoints / Адаптивы** | Responsive-состояния заданы явно и сравниваются как одно логическое дерево. |
| **R** | **Roles / Роли** | У каждого слоя есть понятная роль: flow, absolute или target. |
| **I** | **Identity / Идентичность** | Логические элементы сохраняют stable keys и места в дереве между адаптивами. |
