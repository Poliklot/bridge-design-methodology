...
| --- | --- | --- |
| **B** | **Breakpoints / Адаптивы** | Responsive-состояния заданы явно и их можно сравнить. |
| **R** | **Roles / Роли** | У каждого слоя есть понятная роль: flow, absolute или target. |
| **I** | **Identity / Идентичность** | Логические элементы сохраняют стабильные keys между адаптивами. |
...
Никаких случайных free-floating слоёв. Никаких кнопок “потом поймём куда ведёт”. Никаких адаптивов, где незаметно изменился смысл текста.
